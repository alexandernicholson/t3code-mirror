...
| Oh My Pi    | Install [OMP](https://omp.sh), then configure a model or provider credential in `omp`.       |
...
[Claude](./providers-claude.md), [OpenCode](./providers-opencode.md), [Oh My Pi](./providers-omp.md), and
